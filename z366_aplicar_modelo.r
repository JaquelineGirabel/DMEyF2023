...
PARAM$rpart$cp <- -0.1556
PARAM$rpart$minsplit <- 4584/0.7
PARAM$rpart$minbucket <- 206/0.7
...
setwd("C:/Users/jaqueline.girabel/source/repos/DM_Economia_Finanzas/dmeyf2023") # Establezco el Working Directory
